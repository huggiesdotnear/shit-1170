...
import {
  ...
  fetchShitPrice,
  type PoolInfo,
} from "../../ts/info/shit_lp_price_ref";
                ...
                <div className="token-amount">
                  ...
                  <div>
                    <span className="amount-value">
                      {formatTokenAmount(pool.token0_amount_human)}
                    </span>
                    <span className="usd-value">
                      {" "}
                      ({formatTVL(pool.token0_usd_value)})
                    </span>
                  </div>
                </div>
                <div className="token-amount">
                  ...
                  <div>
                    <span className="amount-value">
                      {formatTokenAmount(pool.token1_amount_human)}
                    </span>
                    <span className="usd-value">
                      {" "}
                      ({formatTVL(pool.token1_usd_value)})
                    </span>
                  </div>
                </div>
              </div>
